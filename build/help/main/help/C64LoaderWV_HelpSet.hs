...
<!-- HelpSet auto-generated on Thu Apr 28 17:23:01 CEST 2022 -->
<helpset version="2.0">
	<title>C64LoaderWV HelpSet</title>
	<maps>
		<mapref location="C64LoaderWV_map.xml" />
	</maps>
	<view mergetype="javax.help.UniteAppendMerge">
		<name>TOC</name>
		<label>Ghidra Table of Contents</label>
		<type>docking.help.CustomTOCView</type>
		<data>C64LoaderWV_TOC.xml</data>
	</view>
	<view>
		<name>Search</name>
		<label>Search for Keywords</label>
		<type>docking.help.CustomSearchView</type>
		<data engine="com.sun.java.help.search.DefaultSearchEngine">C64LoaderWV_JavaHelpSearch</data>
	</view>
	<view>
		<name>Favorites</name>
